// 자바 스크립트는 원시 타입을 제외하면 모든 데이터 타입이 객체 임
...
let memberInfo = {
  ...
  }, // 내부에 있는 값에 접근하려면 this. 필요함
};
console.log(memberInfo.age);
console.log(memberInfo);
console.log(memberInfo.getInfo());

// 비교 연산자 : 자바스크립트에서는 동등연사자와 일치 연산자가 있음
console.log(1 == "1"); // true, 동등연산자, 값이 같은지 확인
console.log(1 === "1"); // false, 일치연산자, 값과 타입이 같은지 확인

console.log(1 !== "1"); // true, 일치 연산자, 값과 타입이 다른지 확인
console.log(1 != "1"); // false, 동등 연산자, 값이 다른지 확인

// 형변환 : 묵지석 형변환과 명시적 형변환
